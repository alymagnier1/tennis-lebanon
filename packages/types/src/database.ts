...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      extend_match_listing: { Args: { p_match_id: string }; Returns: undefined }
      ...
      match_is_stale_warning: { Args: { p_match_id: string }; Returns: boolean }
      ...
      match_participant_count: { Args: { p_match_id: string }; Returns: number }
      ...
      resubmit_match_result: {
        Args: { p_match_id: string; p_score: Json; p_side_a_user_ids: string[] }
        Returns: undefined
      }
      review_pilot_club: {
      ...
      set_recurring_availability: { Args: { p_windows: Json }; Returns: number }
      skill_band_rank: {
